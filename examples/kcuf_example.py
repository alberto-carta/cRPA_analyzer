...
WcRPA_wr = parser.load_nonlocal_interactions(calc.n_orb, r_cutoff=5.1, 
                                           chi_wr_template=chi00_wr)
chi_nonlocal_wk, chi_nonlocal_wr = calc.compute_rpa_susceptibility_nonlocal(WcRPA_wr)

# Plot susceptibilities
print("Plotting susceptibilities...")
plot_chi_comparison(chi00_wk, chi_local_wk, k_vecs, k_plot, k_ticks, 
                    path_tick_labels, channels=['charge'])
