...
# wannier90 run
mpirun -n $ncpu pw.x -nk 128 < ${seedname}.nscf_wannier.in > ${seedname}.nscf_wannier.out
wannier90.x -pp ${seedname}
mpirun -n $ncpu pw2wannier90.x -pd .true. < ${seedname}.pw2wan.in > ${seedname}.pw2wan.out
